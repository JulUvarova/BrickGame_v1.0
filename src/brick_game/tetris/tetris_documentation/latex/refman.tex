...
\chapter{Классы}
\input{structGame__t}
\input{structGameInfo__t}
\chapter{Файлы}
\input{tetris__backend_8h}
\input{tetris__backend_8h_source}
\input{objects_8h}
